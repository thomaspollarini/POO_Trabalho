...
public class Principal {
            ...
            switch (x) {
                case 1:
                    ...
                    while (y <= 0 || y >= 3) {
                        ...
                        if (y == 1) {
                            Cachorro animal=null;

                            do {
                                System.out.println("Tem perdigree? (true ou false)");
                                String perdigree = Util.leString();

                                if (perdigree.equals("true")) {
                                    animal = new Cachorro(cod,nome,end,cid,true);
                                    y = 1;
                                } else {
                                    if (perdigree.equals("false")) {
                                        animal = new Cachorro(cod,nome,end,cid,false);
                                        y = 1;
                                    } else {
                                        System.out.println("Opção inválida");
                                        y = 2;
                            ...
                            if (animalService.inserir(animal)) {
                            ...
                            if (y == 2) {
                                ...
                                do {
                                    ...
                                    if (y == 1) {
                                        animal= new Gato(cod, nome, end, cid, TipoDocumento.CPF, null);
                                        do {
                                            System.out.println("Número de documento do dono: ");
                                            String cpf = Util.leString();

                                            try {
                                                animal.setNumeroDocumento(cpf);
                                                y = 1;
                                        ...
                                        if (y == 2) {
                                            animal= new Gato(cod, nome, end, cid, TipoDocumento.CNPJ, null);
                                            do {
                                                System.out.println("Número de documento do dono: ");
                                                String cnpj = Util.leString();
                                                
                                                try {
                                                    animal.setNumeroDocumento(cnpj);
                                                    y = 2;
                                                } catch (DocumentoException e) {
                                                    System.out.println(e.getMessage());
                                                    y = 1;
    ...
    public static void maiorAtendimento() {
        ...
        if (atendimento != null) { //verifica se retorno foi nulo
            ...
            System.out.println("RELATÓRIO - ATENDIMENTO DE MAIOR VALOR: " + servico.getNome() 
                    + " Valor: " + servico.getValor()*atendimento.getAnimal().getTaxa());
        } else {
    ...
    public static void menorAtendimento() {
        ...
        if (atendimento != null) {  //verifica se retorno foi nulo
            ...
            System.out.println("RELATÓRIO - ATENDIMENTO DE MENOR VALOR: " + servico.getNome() + " Valor: " 
                    + servico.getValor()*atendimento.getAnimal().getTaxa());
        } else {
            System.out.println("Falha ao buscar atendimento");
        }
